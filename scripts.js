...
Note: Modifications for accessibility and row and column filtering by Ken Petri
...
/*****************************
Creates collapsible note areas from 'collapsible-note' elements
******************************/
(function(window, document, undefined) {
    ...
    var toggleCollapse = function(e) {
        if (this.getAttribute("aria-expanded") == "false") {
            ...
            this.firstChild.innerHTML = "&ndash; ";
            this.firstChild.nextSibling.nodeValue = "Hide Details";
            ...
            this.firstChild.nextSibling.nodeValue = "View Details";
            this.nextSibling.style.display = "none";
        }
        TableLock("playermatrix", "row", "column", "locked"); // necessary for visual resizing of left column
    };

    var notes = document.getElementsByClassName('collapsible-note');

    for (var i = 0; i < notes.length; i++) {
        var curnote = notes[i];
        var contents = curnote.innerHTML;
        curnote.innerHTML = "";
        var togglebutton = document.createElement("button");
        togglebutton.setAttribute("aria-expanded", "false");
        var togglespan = document.createElement("span");
        togglespan.setAttribute("aria-hidden", "true");
        var buttext = document.createTextNode("View Details");
        var spantext = document.createTextNode("+ ");
        togglespan.appendChild(spantext);
        togglebutton.appendChild(togglespan);
        togglebutton.appendChild(buttext);
        var colldiv = document.createElement("div");
        colldiv.setAttribute("class", "collapsible");
        colldiv.style.display = "none";
        colldiv.innerHTML = contents;
        curnote.appendChild(togglebutton);
        curnote.appendChild(colldiv);
        togglebutton.addEventListener("click", toggleCollapse, false);
    }
